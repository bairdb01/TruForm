 ...
 * Alpha.ino
 * Author: Rob Little
 * This File is what is running the arduino.
 * It is responsible for gathering all of the sensor data,
 * normalizing the data, sending the data, and revicing any data from the app.
*/
