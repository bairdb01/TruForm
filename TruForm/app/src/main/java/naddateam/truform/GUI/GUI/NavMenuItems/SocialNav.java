 ...
 * Naddateam Truform
 * AboutNav.java
 * Author: Erik Hoffman & Benjamin Baird
...
public class SocialNav extends Fragment implements View.OnClickListener {
    ...
    private static final String PREF_NAME = "TruForm";
    private static final String PREF_KEY_OAUTH_TOKEN = "oauth_token";
    private static final String PREF_KEY_OAUTH_SECRET = "oauth_token_secret";
    private static final String PREF_KEY_TWITTER_LOGIN = "is_twitter_loggedin";
    private static final String PREF_USER_NAME = "TruFormOfficial";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        shareLayout = rootview.findViewById(R.id.share_layout);
        mShareEditText = (EditText) rootview.findViewById(R.id.share_text);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                loginLayout.setVisibility(View.GONE);
                shareLayout.setVisibility(View.VISIBLE);
                userName.setText(getActivity().getResources().getString(
