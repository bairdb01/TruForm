 ...
 * given Bluetooth LE device.
 */
public class BluetoothLeUart extends Service {
    private final static String TAG = BluetoothLeUart.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        BluetoothLeUart getService() {
            return BluetoothLeUart.this;
        }
    }
