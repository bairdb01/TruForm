...
public class Bluetooth extends BlueTest implements BluetoothLeUart.Callback {
    ...
    public void testMethod(final BluetoothGatt gatt, final BluetoothDevice device, final Context context)
    {
